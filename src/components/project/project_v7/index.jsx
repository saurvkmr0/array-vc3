                                    ...
                                    >
                                    {
                                        data.slice(17,21).map(item => (
                                            <SwiperSlide key={item.id}> */}
                                                <div className="project-box-style6" style={{display:'flex', gap:'30px', gap: isMobile ? '15px' : '30px',
                flexDirection: isMobile ? 'column' : 'row',}}>
                                                    <span className="boder"></span>
                                                    <div className="img-box">
                                                        <div className="image" style={{backgroundColor:'#1e2835'}}>
                                                            <img src={require("../../../assets/images/array-vc/personal-infothumb.png")} alt="" /> 
                                                        </div>
                                                        <div className="content">
                                                            <div className="img-box">
                                                                ...
                                                                <div className="content-inner">
                                                                        <h5 className="heading"><Link to="/project_v1">Convertible Note</Link></h5>
                                                    ...
                                                    <div className="img-box">
                                                        <div className="image" style={{backgroundColor:'#1e2835'}}>
                                                            <img src={require("../../../assets/images/array-vc/startup.png")} alt="" style={{width:'98%'}}/> 
                                                        </div>
                                                        <div className="content">
                                                            <div className="img-box">
                                                                {/* <div className="image_inner">
                                                                ...
                                                                <div className="content-inner">
                                                                        <h5 className="heading"><Link to="/project_v1">Valuation</Link></h5>
                                                                        <p className="desc">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
                                                                </div> 
                                                            </div>
                                                            <div className="content-bottom"> 
